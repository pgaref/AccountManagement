...
function submit(){
	if (document.getElementById("email1").checked==false){
		if (document.getElementById("phone1").checked==false){
			document.getElementById("errors").innerHTML="dialeksw";
		}
	}
}

function make_visible_if(){
...
var pathArray = window.location.pathname.split( '/' );
	...
	if (ids=="notifications"){
		...
		document.getElementById('t5').className = "active";
	
	}
	if (ids=="fileupload"){
		
		document.getElementById('t6').className = "active";
	
	}
	if (ids==""){
		
		document.getElementById('t0').className = "active";
	...
	if (ids=="debtors"){
		...
		document.getElementById("debtors").style.background ="#eee";
	
	}
	if (ids=="history"){
		
		document.getElementById("delete").style.background ="#eee";
	
	}
	

	}
function change_url(go_to){
	 location.href = "./"+go_to;
...
function make_visible_search_list(){ 
